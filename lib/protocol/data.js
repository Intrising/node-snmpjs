...
SnmpInteger.prototype.encode = function _integer_encode(writer) {
	//console.log("_integer_encode , this._value = ", this._value , "this._tag = ",this._tag);
	writer.writeInt(this._value, this._tag);
	//console.log("SnmpInteger writer = " , writer);
};
...
SnmpOctetString.prototype.encode = function _octetstring_encode(writer) {
	//console.log("_octetstring_encode , this._value = ", this._value , "this._tag = ",this._tag);
	writer.writeBuffer(this._value, this._tag);
	//console.log("_octetstring_encode writer = " , writer);
};
...
SnmpOID.prototype.encode = function _oid_encode(writer) {
	//console.log("_oid_encode , this._value = ", this._value , "this._tag = ",this._tag);
...
SnmpIpAddress.prototype.encode = function _ipaddress_encode(writer) {
	//console.log("_ipaddress_encode , buf = ", buf , "this._tag = ",this._tag);
...
SnmpCounter32.prototype.encode = function _counter32_encode(writer) {
	//console.log("_counter32_encode , this._value = ", this._value , "this._tag = ",this._tag);
	var bytes = [];
	var v = this._value;
...
SnmpCounter64.prototype.encode = function _counter64_encode(writer) {
	//console.log("_counter64_encode , this._value = ", this._value , "this._tag = ",this._tag);
	var bytes = [];
	var v = {
		hi: this._value.hi,
		lo: this._value.lo
...
SnmpNull.prototype.encode = function _null_encode(writer) {
	//console.log("_null_encode , this._value = ", this._value , "this._tag = ",this._tag);
	if (this._value === null) {
		writer.writeNull();
	} else {
