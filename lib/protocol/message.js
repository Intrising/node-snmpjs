...
SnmpMessage.prototype.encode = function encode()
{
	...
	if(this.version != 3){
		...
		len = 0 + 12;
		len += this._v3.secmsg.EngineID._value.length + /*EngineBoots*/ 1 + /*EngineTime*/3 + this._v3.secmsg.userName._value.length + this._v3.secmsg.params._value.length + this._v3.secmsg.privacyParams._value.length;
		//console.log("len = " , len);
